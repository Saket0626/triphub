...
export const LOYALTY_PROGRAMS = [
  ...
  { id: "cathay_marco", label: "Cathay Marco Polo Club", kind: "airline" as const, match: ["cathay", "cx"] },
  { id: "korean_skypass", label: "Korean Air SkyPass", kind: "airline" as const, match: ["korean", "ke"] },
  { id: "latam_pass", label: "LATAM Pass", kind: "airline" as const, match: ["latam", "la"] },
  { id: "aeromexico_club", label: "Aeromexico Club Premier", kind: "airline" as const, match: ["aeromexico", "am"] },
