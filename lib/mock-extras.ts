  ...
  return [
    {
      ...
      description: `Typical Uber/Lyft/Bolt fare from ${trip.destinationCode} into ${city}.`,
      priceEstimate: 42,
    ...
    },
    {
      id: "fullsize_rental",
      kind: "rental_car",
      title: "Full-size or SUV rental",
      description: "More space for bags and extra people.",
      priceEstimate: 92,
      details: "Per day. Good if you have golf clubs, car seats, or a longer drive.",
    },
    {
      id: "private_transfer",
    ...
    },
    {
      ...
      description: "Hotel-drop van, cheaper than a private car.",
      priceEstimate: 28,
      details: "Per person. May make a few hotel stops. Typical wait 15–40 minutes after landing.",
    },
    {
      id: "public_transit",
      kind: "public_transit",
      title: "Airport rail or bus",
      description: `Public transit from ${trip.destinationCode} into ${city} center.`,
      priceEstimate: 12,
    ...
    },
    {
      id: "luxury_van",
      kind: "private_transfer",
      title: "Luxury van for the group",
      description: "Sprinter-style van with luggage space for 6–10 people.",
      priceEstimate: 145,
      details: "Fixed price for the vehicle. Meet-and-greet. Child seats on request.",
    },
    {
      id: "hourly_car",
      kind: "private_transfer",
      title: "Hourly car and driver",
      description: "Keep a driver for the first afternoon of errands and hotel drop-off.",
      priceEstimate: 85,
